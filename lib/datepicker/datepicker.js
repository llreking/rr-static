 ...
 //   var cssEle = document.createElement("style");
    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            var pree;
            var _maxWidth=(typeof (_self.maxWidth) == 'number'||(!(_self.maxWidth+'').contains('%')&&!(_self.maxWidth+'').contains('px')) ? _self.maxWidth + 'px' : _self.maxWidth);
            //呼出日期插件
            function popupDate(e) {
                _self.gearDate = document.createElement("div");
                _self.gearDate.className = "gearDate";
                _self.gearDate.innerHTML = '<div class="dp-outer-box"><div style="max-width:'+_maxWidth+'" class="date_ctrl slideInUp">' +
            ...
            function popupYM(e) {
                _self.gearDate = document.createElement("div");
                _self.gearDate.className = "gearDate";
                _self.gearDate.innerHTML = '<div class="dp-outer-box"><div class="date_ctrl slideInUp" style="max-width:'+_maxWidth+'">' +
                    '<div class="date_btn_box">' +
                    '<div class="date_btn lcalendar_cancel">取消</div>' +
                    '<div class="date_btn lcalendar_finish">确定</div>' +
                    '</div>' +
