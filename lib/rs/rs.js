!(function ($) {
    ...
    $.alert = $.confirm = function (option) {
        function ConfirmBox(op) {
            var that = this;
            this.settings = { title: "提示", content: "hello", buttons: { "确定": { action: null } }, success: null, maxWidth: 350, titleCenter: true,contentCenter:true,showClose:false,dark:false,background:''};
            ...
            this.create = function () {
                ...
                if (this.settings.showClose) {
                    $c.find('.confirmbox').append('<a class="rf rf-close confirmbox-close"></a>')
                }
